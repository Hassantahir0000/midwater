...
exports.AppNetworkService = void 0;
var core_1 = require("@angular/core");
var network_1 = require("@capacitor/network");
var AppNetworkService = /** @class */ (function () {
    function AppNetworkService(appAlertService) {
        this.appAlertService = appAlertService;
        this.checkInternetConnection();
    }
    AppNetworkService.prototype.checkInternetConnection = function () {
        var _this = this;
        var handler = network_1.Network.addListener('networkStatusChange', function (status) { return __awaiter(_this, void 0, void 0, function () {
...
exports.AppNetworkService = AppNetworkService;
