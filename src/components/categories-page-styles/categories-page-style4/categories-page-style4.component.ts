...
@Component({
  ...
  templateUrl: './categories-page-style4.component.html',
  styleUrls: ['./categories-page-style4.component.scss'],
})
export class CategoriesPageStyle4Component implements OnInit {
  ...
  ngOnInit() {
    console.log("Categories are : ",this.categoriesArray);
  }
